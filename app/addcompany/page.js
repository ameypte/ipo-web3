...
export default function IPOListingForm() {
  ...
  const handleSliderChange = (percentage, setPercentage) => {
    ...
    if (percentage <= remainingPercentage) {
      ...
      // You can handle this case as per your requirement (e.g., show a warning)
    }
  };
      ...
      <section className="bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex flex-col space-y-4">
          <table className="min-w-full border border-gray-300 dark:border-gray-600">
            <thead>
              <tr>
                <th className="py-2 px-4 bg-gray-200 dark:bg-gray-700 border-b dark:border-gray-600">Investor Type</th>
                <th className="py-2 px-4 bg-gray-200 dark:bg-gray-700 border-b dark:border-gray-600">Percentage Share</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-2 px-4">QIB</td>
              ...
              <tr>
                <td className="py-2 px-4">Stakeholder</td>
                <td className="py-2 px-4">
                  <div className="flex items-center">
                    <input
                      type="range"
